...
<body>
  ...
  <main>
    ...
    <ul>
      <li><strong>Cookies Funcionais:</strong> Esses cookies são essenciais para o funcionamento do site e não podem ser desativados. Eles são usados para salvar suas preferências, como a sala selecionada no cronograma e a escolha do tema (claro ou escuro).</li>
