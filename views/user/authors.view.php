...
<body>
  ...
  <main>
    <p>Esse website foi desenvolvido para o <strong>TCC de 2024</strong> para o curso de <strong>Informática para Internet da ETEC João Berlamino</strong> como itinerário da escola <strong>E. E. Prof. Clodoveu Barbosa</strong>.</p>
    ...
    <ul id="authors">
      <li class="author__item">
        ...
        <div class="author__item__contact">
          <a
            href="https://wa.me/+5519998302892"
            class="icons nomargin square big brands whatsapp after extern"
            title="Conversar com Giovanni no WhatsApp">
          </a>
          <a
            href="mailto:giovanniedarosa@gmail.com"
            class="icons nomargin square big outline envelope after extern"
            title="Enviar email para Giovanni">
          </a>
          <a
            href="https://github.com/GiovanniEliasDaRosa"
            class="icons nomargin square big brands github after extern"
            title="Ir para perfil de Giovanni no GitHub">
          </a>
          <a
            href="https://www.linkedin.com/in/giovanni-elias"
            class="icons nomargin square big brands linkedin after extern"
            title="Ir para perfil de Giovanni no LinkedIn">
          </a>
        </div>
      </li>
      ...
      <li class="author__item">
        ...
        <div class="author__item__contact">
          <a
            href="https://wa.me/+5519998576921"
            class="icons nomargin square big brands whatsapp after extern"
            title="Conversar com Laís no WhatsApp">
          </a>
          <a
            href="mailto:laisvitoriacarmelina@gmail.com"
            class="icons nomargin square big outline envelope after extern"
            title="Enviar email para Laís">
          </a>
        </div>
      </li>
