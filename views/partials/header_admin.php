<header id="header" class="hasBG">
  ...
  <div id="header__options" data-admin="true">
    <a class="header__options__button normal__nav <?= headerCronogram() ?>" href="/admin" style="display: none;" aria-disabled="true" disabled="true">Horários</a>
    <a class="header__options__button normal__nav <?= empty($headerSelected) ? 'active' : '' ?>" href="/admin/avisos" id="header__options__warnings" style="display: none;" aria-disabled="true" disabled="true">Avisos</a>
    ...
    <form class="normal__nav" method="post" action="/logout" enctype="multipart/form-data" style="display: none;" aria-disabled="true" disabled="true">
    ...
    <nav id="header__popupmenu" style="display: none;" aria-disabled="true" disabled="true">
      ...
      <a class="header__options__button <?= headerCronogram('header__popupmenu__active') ?>" href="/admin">Horários</a>
